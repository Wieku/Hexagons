...
import me.wieku.hexagons.animation.api.AnimationAccessor;
import me.wieku.hexagons.animation.api.AnimationEquation;
...
public class ActorAccessor implements AnimationAccessor<Actor> {
	...
	public static Animation startTween(Animation tween) {
		...
		tween.start(Main.getInstance().getAnimationManager());
		return tween;
	}

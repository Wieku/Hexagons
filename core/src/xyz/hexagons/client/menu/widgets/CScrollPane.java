 ...
 * @author mzechner
 * @author Nathan Sweet */
public class CScrollPane extends WidgetGroup {
	...
	public CScrollPane (Actor widget, com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle style) {
		...
		addCaptureListener(new InputListener() {
			...
			public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
				...
				getStage().setScrollFocus(xyz.hexagons.client.menu.widgets.CScrollPane.this);
	...
	public void draw (Batch batch, float parentAlpha) {
		...
		batch.flush();
		if (ScissorStack.pushScissors(widgetAreaBounds)) {
